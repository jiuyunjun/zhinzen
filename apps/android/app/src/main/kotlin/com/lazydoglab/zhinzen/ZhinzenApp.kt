            ...
            when (viewModel.phase) {
                ...
                Phase.Map ->
                    MapScreen(
                        ...
                        followHeading = viewModel.followHeading,
                        headingFromGps = viewModel.headingFromGps,
                        needsCompassCalibration = viewModel.compassNeedsCalibration,
                        ...
                        followTarget = viewModel.followTarget,
                        followCamera = viewModel.followCamera,
                        followPoint = viewModel.followPoint,
                        followName = viewModel.followName,
                        followUpdatedAt = viewModel.followUpdatedAt,
                        followState = viewModel.followState,
                        ownSpeed = viewModel.ownSpeed,
                        onStartFollow = viewModel::startFollow,
                        onStopFollow = viewModel::stopFollow,
                        onPauseFollow = viewModel::pauseFollow,
                        onSetFollowCamera = viewModel::updateFollowCamera,
